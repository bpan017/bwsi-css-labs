...
def request_sanitized_input(prompt: str) -> float: 
    """
    Function that requests input from the user and ensures it is a valid float.

    Args:
        prompt (str): The prompt to display to the user.

    Returns:
        float: The sanitized input as a float.
    """
    while True:
        try:
...
def request_sanitized_operation(prompt: str) -> str:
    """
    Function that requests an operation from the user and ensures it is valid.

    Args:
        prompt (str): The prompt to display to the user.
    Returns:
        str: The sanitized operation as a string.
    """
